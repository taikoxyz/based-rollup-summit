...
export const SelectDropdown = <T extends ISelectDefaultItem | object>({
    ...
    const valueValue = useMemo(() => (value as any)?.[renderKey!], [value]);
    ...
    return (
        <CSSTransition classNames={css} timeout={200} in={state.active} mountOnEnter unmountOnExit>
            <div
                className={clsx(css.dropdown, classNames?.dropdown || css.dropdown_default)}
                                ...
                                {render?.option ? (
                                    ...
                                    <div
                                        className={clsx(
                                            ...
                                            isActive &&
                                                (classNames?.optionActive ||
                                                    css.optionActive_default)
                                        )}
