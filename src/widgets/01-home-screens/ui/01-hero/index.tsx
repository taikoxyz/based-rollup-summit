...
const CardsTemplate1: React.FC = () => {
    return (
        <div className={css.cards}>
            <div>
                <div className={clsx(css.cards_wrapper)}>
                    <NextLink
            ...
            <div>
                <div className={clsx(css.cards_wrapper)}>
                    ...
                    >
                        ...
                        />
                        <ArrowLinkIcon className={css.cards_link_link_type} />
                    </NextLink>
                </div>
            </div>
        </div>
                ...
                <div className={css.hero_left}>
                    <div className={css.bottom_left}>
                        ...
                        <div className={css.venue}>
                            <img src="/img/icons/nav-arrow-right.svg" />
                            <p>
