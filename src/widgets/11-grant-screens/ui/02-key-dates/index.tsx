                ...
                <div className={css.content}>
                    ...
                    <div className={css.content_right}>
                        <MediaQuery
                            ...
                            children={
                                <div className={css.titles}>
                                    <p className={css.titles_date}>{t("keyDates.dateTitle")}</p>
                        ...
                        <ul className={css.list}>
                            {dates.map((item) => (
                                <li className={css.list_item} key={item.date}>
                                    <h3 className={css.list_title}>{item.date}</h3>
                                    <p className={css.list_description}>{item.description}</p>
                                </li>
                            ))}
                        </ul>
                    </div>
