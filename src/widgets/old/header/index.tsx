...
export const Header: React.FC<Props> = ({ theme = "light", fixed }) => {
    ...
    return (
        <header
            className={clsx(css.header, css["header_" + theme], fixed && css.header_fixed)}
            style={{ background: state.menuActive ? "$kColorThemeWhite" : "" }}
            id="header"
        >
            <div className="container">
                <div className={css.wrapper}>
                    <Link className={css.logo} href="/" data-logo>
                        Taiko
                    ...
                    <MediaQuery
                        ...
                        children={
                            <button
                                className={clsx(css.menuBtn, state.menuActive && css.menuBtnActive)}
