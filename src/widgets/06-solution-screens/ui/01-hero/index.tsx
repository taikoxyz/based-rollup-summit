    ...
    return (
        <section className={css.hero}>
            <div className={css.content}>
                <p className={css.suptitle}>{t("hero.ourSolutions")}</p>
