...
export const Infrastructure: React.FC = () => {
    ...
    return (
        <section className={css.infrastructure} id="infrastructure">
            <h3 className={css.suptitle}>{t("infrastructure.suptitle")}</h3>
                ...
                {items.map((item, id) => (
                    <li className={css.list_item} key={item.title}>
                        <div className={css.list_header}>
                            ...
                            />
                            <p className={css.list_index}>{startFromZero(id + 1)}</p>
                        </div>
