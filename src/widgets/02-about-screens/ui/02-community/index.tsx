                ...
                <div className={css.wrapper}>
                    <div className={css.content}>
                        <div className={css.content_inner}>
                            <p className={css.suptitle}>{t("community.suptitle")}</p>

                            <h2 className={css.title}>{t("community.title")}</h2>

                            <p className={css.text}>{t("community.text")}</p>
                        </div>
                    </div>
                    ...
                    <div className={css.image}>
                        <MediaQuery
                            ...
                            children={<img src="/img/about/community-circle-mobile.svg" alt="" />}
                        />
                        <MediaQuery
                            query="(min-width: 657px)"
                            children={<img src="/img/about/community-circle.svg" alt="" />}
                        />
